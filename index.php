           ...
           <header>
			<nav class="navbar navbar-default navbar-static-top barra_nav" role="navigation">
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					    <div class="enlace">
				        	<a id="modal-452838" href="#modal-container-452838" role="button" class="btn" data-toggle="modal">Agregar tu RSS</a>
		                </div>
				        <div>
                        <?php  REDES('vaslibre', '26465149152', '', '104909365331295810049'); ?>
                         </div> 
				</div>
			</nav>
           </header>
            ...
            <footer>
			<div class="row clearfix">
				<div class="col-md-12 column"><hr />
	 	  <div style="float:right;">
              Licencia de uso:<br /><a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" title="Bajo Licencia Creative Commons"><img alt="Licencia de Creative Commons" style="border-width:0;" width="88" height="31" src="img/88x31.png" /></a><br /></div>

          <div style ="float:left;"><p>Grupo de Usuarios de VaSlibre<br />Valencia - Carabobo - Venezuela<br />
          &copy; <?php echo date("Y",time()); ?> Dise&ntilde;o & Programaci&oacute;n: <a href="http://viserproject.com" target="_blank">ViSerProject.</a></p></div>
				</div>
			</div>
            </footer>
		</div>
